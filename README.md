...
```
>**Note**:- The parameter namespace is hardcoded as `pipelines-tutorial`. It can be also parameterized.
...
```bash
$ echo "$(oc  get route el-voteapp-listener --template='http://{{.spec.host}}')"
```
...
To github.com:praveen4g0/vote-api.git
